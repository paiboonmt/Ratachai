                ...
                <table id="example1" class="table table-sm table-hover">
                  ...
                  <tbody>
                    <?php
                        ...
                        $stmt = $conndb->query("SELECT * FROM member WHERE `group` = 'customer' AND `exp_date` <= curdate() AND exp_date >= '2023-01-01' AND `status` !=  1  ORDER BY id DESC");
                        $stmt->execute();
                        $result = $stmt->fetchAll();
                        foreach ($result as $row) : ?>
                      <tr>
                        <!-- <td>
                          <a href="sql/code_run1.php?id=<?php echo $row['m_card']; ?>" class="btn btn-success"><i class="fas fa-check-circle"></i></a>
                        </td> -->
                        <?php if ( $row['status'] == 1 ) {?>
                        <td>
                        ...
                        <?php } else {?>
                        <td>
                          <a href="member_profile.php?id=<?= $row['id']; ?>" target="_bank" class="btn btn-info"><i class="fas fa-eye"></i></a>
                        </td>
                        <?php } ?>
                        <td><?= $row['m_card'] ?> </td>
