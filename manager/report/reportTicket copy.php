                                        ...
                                        <?php if ( $row['status_code'] == 5 ) { ?>
                                            <tr class="bg-warning">
                                                    ...
                                                    <td colspan="3" class="text-center">
                                                        <a href="voidPrint.php?ref_order_id=<?=$row['ref_order_id']?>&date=<?= $date ?>" target="_blank" class="btn btn-info btn-sm"><i class="fas fa-print"></i></a>
                                                    </td>
                                                </tr>
                                        <?php } else { ?>
                                            <tr>
                                                    ...
                                                    <td><?= $row['AddBy'] ?></td>
                                                    <td class="text-center">
                                                        <a onclick="return confirm('Are your sure delete it ?')" href="voiceTicket.php?id=<?=$row['mid']?>&action=voice"class="btn btn-sm btn-danger"><i class="fas fa-ban"></i></i></a>
                                                    </td>
                                                    <td class="text-center">
